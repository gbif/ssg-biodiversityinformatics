...
# Призыв к созданию альянса знаний о биоразнообразию
...
&nbsp;&nbsp;&nbsp;&nbsp;Поддержка науки и обоснованного планирования:_
...
3.	Обеспечивать платформу для постоянного роста осмысления биоразнообразии путем хранения, наращивания и улучшения существующих знаний

    _Поддержка открытых данных и открытой науки_

4.	Устранять барьеры перед свободной и открытой публикацией и использованем данных, а также к применению принципов FAIR к данным о биоразнообразии ([Wilkinson et al. 2016](https://doi.org/10.1038/sdata.2016.18))
...
Все стороны, заинтересованные в создании, управлении, использовании и интеграции данных о мировом биоразнообразии призываются внести свой вклад в организацию предложенного *альянса знаний о биоразнообразии*, посредством участия в следующих инициативах:
...
_Спасибо [Нина Филиппова](https://orcid.org/0000-0002-9506-0991), [Наталья Иванова](https://orcid.org/0000-0003-0845-9433), [Максим Карабус]() и [Дмитрий Шигель](https://orcid.org/0000-0002-2919-1168) за этот перевод_
