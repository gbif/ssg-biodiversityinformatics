...
В разделе [Discussion](../discussion) предусмотрена возможность участия в дискуссиях по каждой из пяти тем. **Приветствуется участие на других языках, кроме английского**.
