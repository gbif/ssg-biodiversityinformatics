...
<p style="text-align: center;"> [**Vision**](#vision) | [**طموحات**](#ambitions) | [**الخطوات التالية**](#nextsteps) </p>
...
سيتم الاحتفاظ بمزيد من المعلومات وفرص المساهمة في المناقشات ذات الصلة على [الموقع الإلكتروني للتحالف](http://biodiversityinformatics.org). يرجى زيارة [علامة تبويب المناقشات على الموقع الإلكتروني](https://discourse.gbif.org/c/alliance-for-biodiversity-knowledge) للمساهمة في المناقشات حول كل من هذه المجالات الخم. والمساهمات بلغات غير الإنجليزية مرحب به
